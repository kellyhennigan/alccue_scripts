...
%%%%% this script makes the following (unconvolved and convolved) regressors:
% trial onset by condition (alcohol, drugs. etc.)
% whole trial by condition (alcohol, drugs. etc.)
% cue rt
% choice rt
% pref ratings at trial onset
% pref ratings for whole trial
