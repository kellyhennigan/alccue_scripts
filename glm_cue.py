...
# this script calls afni's 3dDeconvolve function to fit a glm to subject's 
# functional data for the nicotine version of the cue reactivity task
...
func_files = 'pp_cue_tlrc_afni.nii.gz'
...
#-#-#-#-#-#-#-#-#-#-#-		Run 3dDeconvolve:		-#-#-#-#-#-#-#-#-#-#-#
	...
	cmd = ('3dDeconvolve '		
		...
		'-stim_file 7 '+func_dir+'/cue_csf_afni.1D -stim_base 7 -stim_label 7 csf ' 
		'-stim_file 8 '+func_dir+'/cue_wm_afni.1D -stim_base 8 -stim_label 8 wm ' 
