...
# path to directory that contains raw data
in_dir = os.path.join(data_dir,'%s','raw')  # %s is subject id

# path to directory for saving out raw data 
out_dir = os.path.join(data_dir,'%s','func_proc') # %s is subject id


# this is used to find raw task data and for the naming of output files
task = 'cue'

# paths to t1 and functional data templates (in group space)
